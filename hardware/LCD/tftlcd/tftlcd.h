...
#define HZSIZE 32   //汉字大小
#define FONTCOLOR  0x0000  //字体颜色
#define LCD_HCENTER 160   //屏幕横向中间
#define LCD_VCENTER 240   //屏幕纵向中间
...
void LCD_ShowFontHZ(u16 x, u16 y, u8 *cn, u16 fontColor);//显示汉字					   						   																			
